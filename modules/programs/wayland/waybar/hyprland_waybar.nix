  ...
  home-manager.users.${user} = {
    ...
    programs.waybar = {
      ...
      style = ''
        ...
        #mode, #clock, #memory, #temperature, #idle_inhibitor, #cpu, #mpd, #mpris, #custom-wall, #temperature, #backlight, #pulseaudio, #network, #battery, #custom-powermenu, #custom-cava-internal {
                padding-left: 10px;
                padding-right: 10px;
              }
              /* #mode { */
      ...
      settings = [{
        ...
        "mpd" = {
          ...
          "on-click-middle" = "foot --title='ncmpcpp' ncmpcpp ";
